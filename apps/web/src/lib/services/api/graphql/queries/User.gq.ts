...
export type MeQuery = { __typename?: 'Query', me: { __typename?: 'UserDto', id: number, role: Types.Role, email?: string | null, firstName: string, lastName: string, lastConnectedAuthenticationProvider: Types.AuthProvider, createdAt: any, updatedAt?: any | null, deletedAt?: any | null } };
