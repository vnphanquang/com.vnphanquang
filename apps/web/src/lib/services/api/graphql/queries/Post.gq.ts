...
export type PostForPageQuery = {
  ...
  postBySlug?: {
    ...
    comments: Array<{
      ...
      id: number;
      updatedAt?: any | null;
      author: { __typename?: 'UserDto'; firstName: string; lastName: string };
    }>;
    locale?: {
...
export type PostLocalesForBlogIndexQuery = {
  __typename?: 'Query';
  postLocales: Array<{
    __typename?: 'PostLocaleDto';
    createdAt: any;
...
export async function getPostForPage(
  { fetch, variables }: GGetParameters<PostForPageQueryVariables>,
...
export const postLocalesForBlogIndex = writable<
  GFetchReturnWithErrors<PostLocalesForBlogIndexQuery>
>({
  errors: [],
  gQueryStatus: 'LOADING',
});
...
// Cached
export async function getPostLocalesForBlogIndex(
  { fetch, variables }: GGetParameters<PostLocalesForBlogIndexQueryVariables>,
  options?: CacheFunctionOptions,
) {
