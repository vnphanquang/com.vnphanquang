...
export type PostLocalesQuery = { __typename?: 'Query', postLocales: Array<{ __typename?: 'PostLocaleDto', id: number, locale: Types.Locale, slug: string, summary: string, title: string, createdAt: any, deleted: boolean, deletedAt?: any | null, published: boolean, publishedAt?: any | null, updatedAt?: any | null, post: { __typename?: 'PostDto', category: Types.PostCategory, createdAt: any, id: number, tags: Array<Types.PostTag>, updatedAt?: any | null, deletedAt?: any | null, deleted: boolean } }> };
...
// Cached
export async function getPostLocales({ fetch, variables }: GGetParameters<PostLocalesQueryVariables>, options?: CacheFunctionOptions) {
