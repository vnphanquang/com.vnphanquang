  ...
  <div class="mt-20 grid place-items-center grid-cols-1 md:grid-cols-2 gap-28">
    ...
    <article>
      <SkewedFlipCard class="w-80 h-64" id="blog" skew="left">
        ...
        <div slot="back" class="text-sm p-8 prose">
          <p class="text-base">
            Absolutely nothing here. Maybe the possibilities are infinite? Perhaps it reflects my empty soul. But really it's just here to balance this UI grid... /shrug
          </p>
      </SkewedFlipCard>
    </article>
  </div>
